...
import IdeahubSubscription from "../misc/IdeahubSubscription";
...
class Subscription extends React.Component {
  ...
  componentDidMount() {
    this.stripeCheckout = window.StripeCheckout.configure({
      ...
      name: "Ideahub",
      description: "Subscribe to Ideahub",
    ...
    return (
      <IdeahubSubscription>
        {({ error, isLoading, subscription }) => {
          ...
          const cancelConfirmation = `Are you sure you want to cancel your subscription? You won't have access to paid Ideahub features.`;
